...
Public Class CrystalVenFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HARD_INSUMOS_INFORMATICOS.CrystalVenFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalVenFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalVenFactura = New CrystalVenFactura
        rpt.Site = Me.Site
        Return rpt
    End Function
