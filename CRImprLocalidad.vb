...
Public Class CRImprLocalidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HARD_INSUMOS_INFORMATICOS.CRImprLocalidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRImprLocalidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRImprLocalidad = New CRImprLocalidad
        rpt.Site = Me.Site
        Return rpt
    End Function
