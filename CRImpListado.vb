...
Public Class CRImpListado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HARD_INSUMOS_INFORMATICOS.CRImpListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRImpListado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRImpListado = New CRImpListado
        rpt.Site = Me.Site
        Return rpt
    End Function
