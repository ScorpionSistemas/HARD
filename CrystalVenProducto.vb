...
Public Class CrystalVenProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HARD_INSUMOS_INFORMATICOS.CrystalVenProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalVenProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalVenProducto = New CrystalVenProducto
        rpt.Site = Me.Site
        Return rpt
    End Function
