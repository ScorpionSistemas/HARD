...
Public Class CrystalVenFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HARD_INSUMOS_INFORMATICOS.CrystalVenFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalVenFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalVenFecha = New CrystalVenFecha
        rpt.Site = Me.Site
        Return rpt
    End Function
